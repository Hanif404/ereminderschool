...
public class TransferSiswaAdapter extends RecyclerView.Adapter<TransferSiswaAdapter.MyViewHolder>{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            select = (CheckBox) view.findViewById(R.id.checkbox_siswa);
        }
    }

    public TransferSiswaAdapter(List<Siswa> siswaList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_tfsiswa, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.select.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                siswaList.get(position).setSelected(holder.select.isChecked());
            }
        });
    }
